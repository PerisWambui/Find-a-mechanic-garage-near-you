...
import com.wambui.dice.fastservice.databinding.ActivityCustomerMapBinding;
...
public class CustomerMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMechanicInfo = (LinearLayout) findViewById(R.id.driverInfo);

        mMechanicName = (TextView) findViewById(R.id.driverName);
        mMechanicPhone = (TextView) findViewById(R.id.driverPhone);
        mMechanicCar = (TextView) findViewById(R.id.driverCar);
                    ...
                    mCustomerDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
                                ...
                                DatabaseReference driverRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Drivers").child(mechanicFoundID).child("customerRequest");
    ...
    private void getDriverLocation() {
        mechanicLocationRef = FirebaseDatabase.getInstance().getReference().child("driversWorking").child(mechanicFoundID).child("l");
        driverLocationRefListener = mechanicLocationRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && requestBol) {
                    ...
                    if (distance < 100) {
                        mRequest.setText("Your Mechanic has arrived");
                    } else {
                    ...
                    mMechanicMarker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("Your Mechanic").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher)));
                }
    ...
    private void getDriverInfo() {
        ...
        DatabaseReference mCustomerDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child("Mechanic").child(mechanicFoundID);
        mCustomerDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
                    ...
                    if (dataSnapshot.child("Car") != null) {
                        mMechanicCar.setText(dataSnapshot.child("Car").getValue().toString());
                    }
    ...
    private void getHasRideEnded() {
        ...
        driveHasEndedRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Drivers").child(mechanicFoundID).child("customerRequest").child("customerRideId");
    ...
    private void endRide() {
        ...
        if (driverLocationRefListener != null && driveHasEndedRefListener != null) {
            mechanicLocationRef.removeEventListener(driverLocationRefListener);
            driveHasEndedRef.removeEventListener(driveHasEndedRefListener);
        }


        if (mechanicFoundID != null) {
            DatabaseReference driverRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Mechanic").child(mechanicFoundID).child("customerRequest");
