...
import com.wambui.dice.fastservice.databinding.ActivityMechanicMapsBinding;
...
public class MechanicMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private ActivityMechanicMapsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mserviceStatus= (Button) findViewById(R.id.rideStatus);
    ...
    private void endRide()
    {
        ...
        mserviceStatus.setText("Pick Patient");
        erasePolylines();
        ...
        public void onLocationResult(LocationResult locationResult) {
            for(Location location : locationResult.getLocations()){
                if(getApplicationContext()!=null){
                    ...
                    myMarker = mMap.addMarker(new MarkerOptions().position(myLocation).title("Your Ambulance").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher)));
